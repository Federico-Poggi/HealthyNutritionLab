            ...
            <Modal show={isOpenProps} className={"backdrop-blur-[10px] relative"} onClose={() => {
                ...
                <ModalBody className={"flex flex-col"}>
                    <div className={"flex justify-between py-2 "}>
                        ...
                        <button
                            onClick={() => onClose()}
                            className={"bg-green-500 text-white font-medium rounded px-2"}>Conferma
                        </button>
                    </div>
                    <div className={"flex"}>
                                ...
                                alimentiDietaSelected.map((ali: Alimento) => {
                                    return (
                                        <Banner key={ali.idAlimento}>
                                            <div
                                                className="flex w-full justify-between border-t border-gray-200 bg-gray-50 p-4 dark:border-gray-600 dark:bg-gray-700">
