...
export function LoginPage() {
    ...
    return (
        <>
            {opened && <div className = {"fixed z-30 inset-0  flex items-center justify-center bg-black bg-opacity-50"}>
                <div className = {"loginModal phone:flex phone:flex-col relative border border-green-400 flex items-center phone:justify-start  justify-between desktop:w-[700px] desktop:h-[300px] tablet:w-[600px] tablet:h-[400px] phone:w-[350px] phone:h-[500px] bg-[#333232]"}>
