...
public class ArticleService {
   ...
   public void assignImg(Long id,MultipartFile img) throws NotFoundException, IOException {
      Article article=articleDAO.findById(id).orElseThrow(()-> new NotFoundException("non trovata"));
   ...
   public ArticleGetResponse converArticleGetResponse(Article a) throws IOException {
      ...
      try{
         ...
         return new ArticleGetResponse(a.getTitle(), encodeFile,a.getImageArticle(),autorName);
      }catch (Exception io){
         throw io;
      }
   }
